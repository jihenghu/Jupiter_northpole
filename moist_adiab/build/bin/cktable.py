...
sys.path.append("/data/jihenghu/juno-mwr-deconv-research/21.polarmean_redo/moist_adiab/build/python")
...
cmake_binary_dir = "/data/jihenghu/juno-mwr-deconv-research/21.polarmean_redo/moist_adiab/build"
